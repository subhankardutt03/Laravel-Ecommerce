			...
			<div class="blog-page">
                ...
                <div class="blog-post  wow fadeInUp">
                    <a href="blog-details.html">
                        <img class="img-responsive" src="{{ asset($post->blog_post_image) }}" alt=""> 
                    </a>
                    <h1>
                        <a href="blog-details.html">
                    ...
                    <p>
                            @if (session()->get('language') == 'hindi')
                                    {!! Str::limit($post->blog_post_details_hin,300) !!}
                                @else
                                    @if (session()->get('language') == 'bengali')
                                        {!! Str::limit($post->blog_post_details_ben,300) !!}
                                    @else
                                        {!! Str::limit($post->blog_post_details_en,300) !!}
                                    @endif
                                @endif
                    </p>
                    <a href="{{ route('details.blogPost',$post->id) }}" class="btn btn-upper btn-primary read-more">
                        read more</a>
                </div>

                    @empty
                    <h2 class="text-danger"><span>Sorry... No Post Found </span></h2>
