    ...
    <div class='container'>
                ...
                <div class="sidebar-widget-body">
                    ...
                    {{ $category->category_name_hin }}
                        ...
                        @foreach ($subcategories as $subcategory)
                            ...
                            <ul>
                            <li><a href="{{ route('subcategory.data',[$subcategory->id,$subcategory->subcategory_slug_en]) }}">
        ...
        <div class='col-md-9'> 
            ...
            @foreach ($breadSubsubCat as $item)
                <span class="badge badge-danger" style="background-color:#20B2AA">{{ $item->category->category_name_en }}</span>
            @endforeach
/
            @foreach ($breadSubsubCat as $item)
                <span class="badge badge-danger" style="background-color:#9370DB">{{ $item->subcategory->subcategory_name_en }}</span>
            @endforeach
/
            @foreach ($breadSubsubCat as $item)
                <span class="badge badge-danger" style="background-color:#FF4500">{{ $item->subsubcategory_name_en }}</span>
            @endforeach
