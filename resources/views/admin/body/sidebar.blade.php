				 ...
				 <a href="index.html">
				  <!-- logo for regular state and mobile devices -->
					 <div class="d-flex align-items-center justify-content-center">					 	
						  <i class="fa fa-cart-arrow-down" style="font-size:50px;color:#ff4555"></i>
						  <a href="{{ url('/admin/dashboard') }}"><h3><b>E Shop</b> Admin</h3></a>
					 </div>
				</a>
			</div>
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">  
        ...
        @if ($brand == true)
          ...
          <ul class="treeview-menu {{ ($route == 'all.brand')? 'active': '' }}">
            <li><a href="{{ route('all.brand')}}"><i class="ti-more"></i>Brand View</a></li>
          </ul>
        </li> 
        ...
        <li class="treeview {{ ($prefix == '/coupons')? 'active': '' }}">
          ...
          <ul class="treeview-menu">
            <li class="{{ ($route == 'manage.coupons')? 'active': '' }}">
              <a href="{{ route('manage.coupons') }}"><i class="ti-more"></i>Manage Coupons</a></li>
          </ul>
        </li>
        ...
        @endif
          ...
          <ul class="treeview-menu">
            <li class="{{ ($route == 'blog.category')? 'active': '' }}">
              <a href="{{ route('blog.category') }}"><i class="ti-more"></i>Blog Category</a></li>
                ...
                <li class="{{ ($route == 'view.blogPost')? 'active': '' }}">
              <a href="{{ route('view.blogPost') }}"><i class="ti-more"></i>View Blog Post</a></li>

                <li class="{{ ($route == 'add.blogPost')? 'active': '' }}">
              <a href="{{ route('add.blogPost') }}"><i class="ti-more"></i>Add Blog Post</a></li>
          ...
          <ul class="treeview-menu">
            <li class="{{ ($route == 'site-setting')? 'active': '' }}">
              ...
              <a href="{{ route('seo-setting') }}"><i class="ti-more"></i>SEO Setting</a></li>
          ...
          <ul class="treeview-menu">
            <li class="{{ ($route == 'site-setting')? 'active': '' }}">
              <a href="{{ route('return-request') }}"><i class="ti-more"></i>Return request</a></li>

                <li class="{{ ($route == 'all-approved-request')? 'active': '' }}">
              <a href="{{ route('all-approved-request') }}"><i class="ti-more"></i>Approved request</a></li>
          ...
          <ul class="treeview-menu">
            <li class="{{ ($route == 'pending-review')? 'active': '' }}">
              ...
              <a href="{{ route('published-review') }}"><i class="ti-more"></i>Published Review</a></li>
          ...
          <ul class="treeview-menu">
            <li class="{{ ($route == 'product-stock')? 'active': '' }}">
              <a href="{{ route('product-stock') }}"><i class="ti-more"></i>Product Stock</a></li>
        ...
        <li class="header nav-small-cap" style="font-weight: bold;font-size:20px;">User Interface</li>
        ...
        @if ($orders == true)
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ ($route == 'confirmed.orders')? 'active': '' }}">
              ...
              <a href="{{ route('cancel.order') }}"><i class="ti-more"></i>Cancel Orders</a></li> 
