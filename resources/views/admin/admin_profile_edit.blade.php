    ...
    <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="mr-auto">
					<h3 class="page-title">Admin Profile Update</h3>
				</div>
			</div>
		</div>	  
		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			...
			<div class="box-body">
			  <div class="row">
				<div class="col">
					<form action="{{ route('update.profile') }}" method="POST" enctype="multipart/form-data" novalidate>
						@csrf
					...
					<div class="row">
						<div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
								        <img src="{{ (!empty($editProfile->profile_photo_path)) ?  
                                        (asset($editProfile->profile_photo_path)) : url('upload/no_image.jpg') }}" 
                                        alt="" style="width: 100px;height:100px;" id="showImage">
                                    </div>
							    </div>
